...
easily available to the potential \textsc{ABCL} 1.6 User, the
implementation for this edition works best with Java 8 or Java 11
...
The User may need to use the facilities of the ABCL-BUILD contrib to
recompile the implementation locally in more exotic runtimes.
...
\texttt{COPYING} in the source distribution\footnote{See
  \url{http://abcl.org/svn/trunk/tags/1.6.0/COPYING}} for the license,
...
\texttt{abcl.jar} or possibly something like \texttt{abcl-1.6.0.jar} if
...
\code{abcl-contrib-1.6.0.jar}.  The contrib jar is not loaded by the
...
\url{http://abcl.org/svn/tags/1.6.0/contrib/abcl-asdf/README.markdown}.
...
\url{http://abcl.org/svn/tags/1.6.0/contrib/asdf-jar/README.markdown}.
...
\url{http://abcl.org/svn/tags/1.6.0/contrib/jss/README.markdown}
...
\url{http://abcl.org/svn/tags/1.6.0/contrib/jfli/README}.
...
\url{http://abcl.org/svn/tags/1.6.0/contrib/abcl-introspect/}.
...
\url{http://abcl.org/svn/tags/1.6.0/contrib/abcl-build/}.
...
\url{http://abcl.org/svn/tags/1.6.0/contrib/named-readtables/}.
...
In June 2017, we released ABCL 1.6.0 which dropped support for running
upon Java 5.

Against the falling canvas of 2019 we released ABCL 1.6.0 which
provided compatibility with Java 11 while skipping Java 9 and 10.
