...
\texttt{COPYING} in the source distribution\footnote{See
  \url{http://abcl.org/svn/trunk/tags/1.6.1/COPYING}} for the license,
...
\texttt{abcl.jar} or possibly something like \texttt{abcl-1.6.1.jar} if
...
\code{abcl-contrib-1.6.1.jar}.  The contrib jar is not loaded by the
...
\url{http://abcl.org/svn/tags/1.6.1/contrib/abcl-asdf/README.markdown}.
...
\url{http://abcl.org/svn/tags/1.6.1/contrib/asdf-jar/README.markdown}.
...
\url{http://abcl.org/svn/tags/1.6.1/contrib/jss/README.markdown}
...
\url{http://abcl.org/svn/tags/1.6.1/contrib/abcl-build/}.
...
\url{http://abcl.org/svn/tags/1.6.1/contrib/named-readtables/}.
