...
\textsc{openjdk8}, \textsc{openjdk11}, and \textsc{openjdk17}.  We
intend to drop one or more of these platforms for the next edition in
order to more completely overhaul the implementations use of compare
and swap on memory originally allocated outside the hosting
\textsc{JVM}.  As such, the Tenth edition is built for release with
openjdk8 but should run best on \textsc{openjdk17}.
...
\texttt{COPYING} in the source distribution\footnote{See
  \url{http://abcl.org/svn/trunk/tags/1.9.0/COPYING}} for the license,
...
\texttt{abcl.jar} or possibly something like \texttt{abcl-1.9.0.jar} if
...
asdf-3.3.5.7 (see \cite{asdf}) is packaged as core component of
...
\code{abcl-contrib-1.9.0.jar}.  The contrib jar is not loaded by the
...
\url{http://abcl.org/svn/tags/1.9.0/contrib/abcl-asdf/README.markdown}.
...
\url{http://abcl.org/svn/tags/1.9.0/contrib/asdf-jar/README.markdown}.
...
\url{http://abcl.org/svn/tags/1.9.0/contrib/jss/README.markdown}
...
\url{http://abcl.org/svn/tags/1.9.0/contrib/jfli/README}.
...
\url{http://abcl.org/svn/tags/1.9.0/contrib/abcl-introspect/}.
...
\url{http://abcl.org/svn/tags/1.9.0/contrib/abcl-build/}.
...
See \url{http://abcl.org/svn/tags/1.9.0/contrib/named-readtables/} for
more information.
