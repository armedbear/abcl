...
\paragraph{}
\label{ABCL-INTROSPECT/SYSTEM:*DEBUGGING-LOCALS-P*}
\index{*DEBUGGING-LOCALS-P*}
--- Variable: \textbf{*debugging-locals-p*} [\textbf{abcl-introspect/system}] \textit{}
...
\paragraph{}
\label{SYSTEM:COMPILER-BYTECODE-LENGTH-ERROR}
\index{COMPILER-BYTECODE-LENGTH-ERROR}
--- Class: \textbf{compiler-bytecode-length-error} [\textbf{system}] \textit{}
...
\paragraph{}
\label{ABCL-INTROSPECT/SYSTEM:FIND-LOCALS}
\index{FIND-LOCALS}
--- Function: \textbf{find-locals} [\textbf{abcl-introspect/system}] \textit{index backtrace}
