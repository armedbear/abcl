...
- For plain REPL only, it is still not working with Sly/Slime. When called inside Sly/Slime main REPL it will only show print a message and return the form without any stepping
